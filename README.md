...
- **The display button shows the tape, not the channels.** With a tape in, pressing the LED
  window brings up the title, the running time and where you are in it — same teletext panel,
  larger type, nothing to scroll. It reverts to the channel list on eject.
